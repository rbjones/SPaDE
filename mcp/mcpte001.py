...
def test_integration():
    ...
    # Adjusted for location: mcp/mcpte001.py -> mcp/mcpcd001.py
    server_script = os.path.join(os.path.dirname(__file__), "mcpcd001.py")
    ...
    env = os.environ.copy()
    # Adjusted for location: mcp/mcpte001.py -> workspace root is ../
