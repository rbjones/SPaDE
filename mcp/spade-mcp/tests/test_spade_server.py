...
def test_integration():
    ...
    # Adjusted for location: mcp/spade-mcp/tests/test_spade_server.py
    server_script = os.path.join(os.path.dirname(__file__), "../src/spade_server.py")
    ...
    env = os.environ.copy()
    # Adjusted for location: mcp/spade-mcp/tests/test_spade_server.py -> workspace root is ../../../
