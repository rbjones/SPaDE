# SPaDE Knowledge Repository - Philosophical Background
...
Such adaptation does not need to be precise in its determination or perfect in execution, a modest statistical advantage may suffice to secure evolutionary progress.
But as more advanced lifeforms evolved the senses have become more precise, and the sophistication of the response has advanced.
...
It is not intended to be a rigorous philosophical treatise, but rather an informal bald account of the ideas which have influenced the design of the SPaDE repository.

At this point I am reorganising three separate attempts to approach this philosophical background in which the first step is cut and paste to put similar considerations in each of four documents, to which this is the introduction.  

## [Declarative Knowledge](krph004.md)

This is a first informal account of the notion of [declarative knowledge](../docs/tlad001.md#declarative-knowledge) as that concept is used in SPaDE.
...
This document begins the exposition of the structure of the SPaDE knowledge repository, which guides its implementation and application.
