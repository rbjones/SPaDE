...
For which agent does the work, see [amms009.md](amms009.md) and [ampd009.md](ampd009.md), and the working-practice section of [README.md](README.md). For Grok Build sessions, also follow [ampd004.md](ampd004.md) (one focus per branch and worktree; do not check out a different branch under a live session).
