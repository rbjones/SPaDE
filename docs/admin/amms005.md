...
For which tool to use (Grok vs Copilot), see the working-practice section of [README.md](README.md). For Grok Build sessions, also follow [ampd004.md](ampd004.md) (one focus per branch and worktree; do not check out a different branch under a live session).
